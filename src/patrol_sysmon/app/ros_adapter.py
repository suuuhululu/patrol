...
- `ros/node.py`: 구독 노드 생성·callback·ReportDetection 서비스·IngestionAck 회신·실행
"""
...
__all__ = [
    ...
    "report_detection_payload", "camera_state_payload",
    ...
    "COSTMAP_SOURCES_BY_TOPIC", "REPORT_DETECTION_SERVICE", "REPORT_EVENT_TYPES",
